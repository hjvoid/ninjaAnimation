...
function init(event) {
    ...
    var container = document.getElementById('ninja');
    ...
    // var textureMap = new THREE.TextureLoader().load("img/TexturesCom_SoilCracked0146_1_seamless_S.jpg");
